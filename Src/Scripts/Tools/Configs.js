...
var velPlayer = 3.5;                      //Velocidade do jogador(padrão 2, quando maior mais rápido)
var velRun = 5.5;                       //Velocidade do jogador ao correr(padrão 3.5, quando maior mais rápido)
